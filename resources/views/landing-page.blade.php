...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>SMK MANDIRI</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="#jurusan" class="nav-item nav-link">Jurusan</a>
                <a href="#kontak" class="nav-item nav-link">Kontak Kami</a>
            </div>
            <a href="/pendaftaran" class="btn btn-primary py-4 px-lg-5 d-lg-block">Daftar Sekarang!<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Selamat Datang di SMK Mandiri</h1>
    ...
    <div class="container-xxl py-5 category" id="jurusan">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Kompetensi Keahlian</h6>
                <h1 class="mb-5">Kompetensi Keahlian yang tersedia</h1>
            </div>
            <div class="row g-3">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Tenaga Pengajar</h6>
    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s" id="kontak">
